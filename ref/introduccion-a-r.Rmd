...
```{r regiones}
reg.sf <- st_read(dsn = 'divisionRD.gpkg', layer = 'REGCenso2010', quiet = T)
plot(reg.sf)
```
...
Veremos otras formas de diseñar mapas estilizados. Veamos también la capa de municipios contenida en el GPKG.

```{r municipios}
mun.sf <- st_read(dsn = 'divisionRD.gpkg', layer = 'MUNCenso2010', quiet = T)
plot(mun.sf)
